...
unsigned int nTargetSpacing = 1 * 60; // ge - 1 minute blocks
...
unsigned int nModifierInterval = 10 * 60; // ge - time to elapse before new modifier is computed
...
const string strMessageMagic = "ge Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "ge", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Lesson number one: Don’t underestimate the other guy’s greed.";
        CTransaction txNew;
        txNew.nTime = 1437135611;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1437135611;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 6496826;
       ...
       if (true && (block.GetHash() != hashGenesisBlock)) {
        ...
        assert(block.hashMerkleRoot == uint256("0xf75cef1463896539a8249f2d732098c641d2c1b1545f9843383fabb7c966e7f3"));
...
unsigned char pchMessageStart[4] = { 0x1b, 0xa9, 0xc2, 0xf4 };
